...
use shared::{
    ...
    maintenance::ServiceMaintenance, pool_fetching::PoolFetcher,
    price_estimate::BaselinePriceEstimator, Web3,
};
...
impl OrderbookServices {
    pub async fn new(
        ...
        let pool_fetcher = OrderbookPoolFetcher::new(Box::new(PoolFetcher {
            pair_provider,
            web3: web3.clone(),
        }));
