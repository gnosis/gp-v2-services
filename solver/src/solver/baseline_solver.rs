...
mod tests {
    ...
    use shared::{addr, sources::balancer::pool_fetching::WeightedPoolState};
    ...
    fn does_not_panic_when_building_solution() {
        ...
        let liquidity = vec![
            ...
            Liquidity::WeightedProduct(WeightedProductOrder {
                reserves: hashmap! {
                    addr!("c778417e063141139fce010982780140aa0cd5ab") => WeightedPoolState {
                    ...
                    addr!("e4b9895e638f54c3bee2a3a78d6a297cc03e0353") => WeightedPoolState {
                        token_state: TokenState {
