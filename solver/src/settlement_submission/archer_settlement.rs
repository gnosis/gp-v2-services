...
// so that we can make use of the property that archer transactions do not cost cast if they fail.
...
impl ArcherSolutionSubmitter {
    ...
    /// Keep submitting the settlement transaction to the archer network as gas prices changes.
    ///
